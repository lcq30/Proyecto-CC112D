...
\section[Parte2]{\foreignlanguage{spanish}{Parte2}}
\section[\ Scikit{}-Learn(diabetes)]{\foreignlanguage{spanish}{\ Scikit-Learn(diabetes)}}

\begin{center}
\lfbox[margin-right=0.1283in,margin-bottom=0.0016in,margin-left=0.1252in,margin-top=0mm,border-style=none,padding=0mm,vertical-align=top,raise=-0.2508in]{\includegraphics[width=7.8508in,height=7.3319in]{a0000-img014.png}}
\end{center}
\section[]{\selectlanguage{spanish}\rmfamily }
